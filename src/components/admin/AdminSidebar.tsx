...
const NAV_GROUPS: Array<{ label: string; items: NavItem[] }> = [
  ...
  },
  {
    ...
    items: [
      { label: "All Opportunities", href: "/admin/opportunities", icon: Search },
      { label: "Search Campaigns", href: "/admin/campaigns", icon: Briefcase },
      { label: "Sources & Connectors", href: "/admin/connectors", icon: Cable },
      { label: "Proposals", href: "/admin/proposals", icon: FileText },
      { label: "Applications", href: "/admin/applications", icon: Send },
      { label: "Contracts", href: "/admin/contracts", icon: Handshake },
      { label: "Customer Interviews", href: "/admin/interviews", icon: MessageSquareText },
      { label: "Pipeline Board", href: "/admin/leads", icon: FileCheck2 },
