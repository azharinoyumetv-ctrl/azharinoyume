...
const products = [
  { key: "project-basic", kind: "PROJECT", name: "Basic automated project", usdCents: 1499, credits: 0, sortOrder: 1 },
  { key: "project-plus", kind: "PROJECT", name: "Plus creator production", usdCents: 4499, credits: 0, sortOrder: 2 },
  { key: "project-premium", kind: "PROJECT", name: "Premium commercial production", usdCents: 12999, credits: 0, sortOrder: 3 },
...
const paymentProviders = [
  { id: "00000000-0000-4000-8000-000000000001", name: "doku", enabled: true, mode: "auto", regions: ["ID"], config: { supports: ["PACK", "PROJECT"] } },
  { id: "00000000-0000-4000-8000-000000000002", name: "xendit", enabled: true, mode: "auto", regions: ["ID"], config: { supports: ["PACK", "SUBSCRIPTION", "PROJECT"] } },
  { id: "00000000-0000-4000-8000-000000000003", name: "payoneer", enabled: false, mode: "manual", regions: ["GLOBAL"], config: { supports: ["PACK", "PROJECT"] } },
] as const;
